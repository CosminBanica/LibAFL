    ...
    T: AddressFilter,
{
    ...
    fn convert_to_string(&self) -> String {
        match self {
            FilterList::AllowList(allow_list) => allow_list.convert_to_string(),
            FilterList::DenyList(deny_list) => deny_list.convert_to_string(),
            FilterList::None => String::new(),
        }
    }
}
...
impl AddressFilter for AddressFilterVec {
    ...
    fn convert_to_string(&self) -> String {
        ...
        for rng in self.registered_addresses.iter() {
